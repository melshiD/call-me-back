### Retain this note: ### *(this file is an alias for PROJECT_CONTEXT_REVIEW.md, which the user grew tired of typing out in the terminal.  It has been changed to PCR.md for brevity)*
