...
<!-- Demo Mode Toggle - Moved to @/components/DemoModeToggle.vue for future use
             To enable: import DemoModeToggle from '@/components/DemoModeToggle.vue'
             Then use: <DemoModeToggle v-model="demoMode" />
        -->
      </div>
...
// Demo mode - obscures sensitive data for screen recording (toggle moved to @/components/DemoModeToggle.vue)
